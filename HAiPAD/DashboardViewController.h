...
@interface DashboardViewController : UIViewController <HomeAssistantClientDelegate, UICollectionViewDataSource, UICollectionViewDelegate, WhiteboardGridLayoutDelegate, EntityCardCellResizeDelegate>
